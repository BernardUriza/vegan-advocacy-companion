...
Primera aparición (hilo cow-gives-milk, 2026-08-08). Trae un dato real (los AMS/robot milkers existen y las vacas hacen fila) como refutación de la apropiación. Buena fe empírica: cree que el hecho zanja la ética. El hueco: la voluntariedad ocurre DENTRO de condiciones fabricadas — ubre criada para 10x el rendimiento del ternero, ternero removido, presión que la vaca va a aliviar. El acuerdo con la máquina no toca el título sobre su cuerpo.
...
NO disputar el dato (los robot milkers existen, las vacas sí van solas — concederlo de entrada, es buena fe). NO pelear welfare (mejor trato no cambia el estatus). Mostrar que la voluntariedad vive dentro de la disponibilidad fabricada y devolver el título.

...
El mejor steelman anti-vegano del hilo, y CIVIL. Hace tres cosas finas: (1) acusa a Bernard de asumir la conclusión ('asumes que las alternativas son equivalentes' — sube la vara de ADECUADO a EQUIVALENTE para fabricar un esquive); (2) escudo relativista ('es creencia moral, no hecho objetivo'); (3) su propio principio 'sufrimiento INNECESARIO minimizado' ya concede que el sufrimiento debe ser necesario para ser permisible — si hay alternativas, no es necesario, y su principio aterriza en veganismo. Nadie (ni Rüdiger) lo ha contestado. ES EL FRENTE DE MAYOR PALANCA: contestar al opositor más inteligente en el propio post de Bernard educa al lurker más que cualquier pelea con Grant.
...
No pelear el relativismo en abstracto (concederlo: no hace falta un hecho moral objetivo para preguntar qué creencia sobrevive el escrutinio). No dejar pasar el 'necesario' que él mismo metió. No aceptar la vara 'equivalente' — la pregunta solo necesita alternativas ADECUADAS.
...
### Hilo `4587084521560658` — 2026-07-04 · outcome: **pending**

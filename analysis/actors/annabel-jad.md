...
Enuncia, terse y sin insulto, la tesis EXACTA que el post abolicionista ataca: no-humano = propiedad. La premisa oculta y no defendida es que 'someone'/estatus moral = ser de la especie humana. Eso es antropoespecismo en estado puro (la especie hace todo el trabajo) y ademas es la forma logica de la propiedad esclavista historica: declarar a una clase 'no-personas' para poder poseerla. NO defiende POR QUE la membresia de especie confiere la proteccion; la asume. Alto valor de lurker porque la premisa, una vez nombrada, se ve arbitraria.
...
NO afirmar 'los animales SI son personas/someone' como premisa demostrada (peticion de principio, justo lo que su objecion explota). NO redactar el eje como dano/sufrimiento. Nombrar que 'people' es una etiqueta de ESPECIE, no un criterio moral, y preguntar QUE rasgo (no la etiqueta) supuestamente convierte a un humano en alguien-no-poseible y por que ese rasgo falta en un cerdo. Recordar al pasar que 'declarar a una clase no-personas' fue la formula de la propiedad esclavista.

...
Un turno. Versión condensada del esquive de Les M: pluraliza las razones para evitar nombrar el principio que hace el trabajo. Futility + escudo de principio.
...
No perseguir cada razón de la lista. Nombrar que la pluralidad es el esquive: ninguna de esas describe POR QUÉ es permisible matar cuando no hace falta.
...
### Hilo `27363745576581926` — 2026-06-20 · outcome: **silent**
- **Su jugada:** Colapsa razón=justificación explícito: "the reason someone does something is their justification and vice versa"; "it is my life, my decision, my morality"; tono grosero (hairy Shetland pony).
- **Nuestra respuesta:** Reply etiquetada (filo): nombré el equívoco — una razón EXPLICA, una justificación DEFIENDE; si fueran lo mismo nada sería injustificable (el que tortura por placer "tiene su razón"); Tom no defiende su práctica, dice que no tiene que defenderla, lo cual es postura no argumento; "es mi vida" no responde porque otro sintiente carga el costo; devolví al hueso: qué principio justifica cuando hay alternativa adecuada. No perseguí la lista, no mordí el tono.

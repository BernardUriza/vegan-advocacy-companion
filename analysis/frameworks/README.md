# Arsenal de frameworks — vista generada

> GENERATED from `data/frameworks.json` by `scripts/gen-frameworks.mjs`. Do not hand-edit — edit the JSON and regenerate.

**77 frameworks** de **8 autores.** Cada uno es un concepto/jugada deployable; `deploy_as` y `attack_surface` gobiernan CÓMO usarlo (marco, nunca premisa portante salvo que sea inatacable; varios son auto-disciplina del activista, no armas).

## Resumen

| Framework | Autor | deploy_as | Registro | Efectividad (actors.json) |
|---|---|---|---|---|
| [Antropoespecismo / Especismo Antropocéntrico](#antropoespecismo) | Samuel Guerrero | marco | filo | 2 deploys · pending ×2 |
...
| [Domesticar es un eufemismo de dominar/someter](#domesticar-eufemismo-dominar) | Samuel Guerrero | marco | filo | sin probar |
| [De algo a alguien — objeto de propiedad a sujeto de derecho](#algo-a-alguien-sujeto-derecho) | Samuel Guerrero | marco | compasivo | 3 deploys · pending ×3 |
| [La no-necesidad: las reglas del juego cambiaron para siempre](#no-necesidad-cambiaron-las-reglas) | Samuel Guerrero | premisa_portante | filo | 6 deploys · pending ×6 |
...
| [El conocimiento compromete — ya no puedes hacer como que no sabes](#conocimiento-compromete) | Samuel Guerrero | marco | filo | sin probar |
...
| [El carnismo manda el antropoespecismo de vuelta al anonimato](#carnismo-anonimato-critica) | Samuel Guerrero | marco | filo | sin probar |
| [Génesis: la Biblia promueve el antropoespecismo, no el veganismo](#genesis-invertido) | Samuel Guerrero | marco | filo | sin probar |
| ['Vegano por un día' = racista solo entre semana](#vegano-por-un-dia-racista-entre-semana) | Samuel Guerrero | marco | filo | sin probar |
| [El veganismo no es un estilo de vida (no se elige no ser racista)](#no-es-opcion-de-vida) | Samuel Guerrero | marco | compasivo | 1 deploy · pending ×1 |
| ['Vegano' es un vocablo vacío: el norte es formar activistas](#formar-activistas-no-veganos) | Samuel Guerrero | auto-disciplina-del-activista | compasivo | sin probar |
| [Entender no es aceptar ni transformarse](#entender-no-es-transformarse) | Samuel Guerrero | auto-disciplina-del-activista | compasivo | sin probar |
| [Me preocupa más el movimiento que la sociedad](#preocupa-mas-el-movimiento) | Samuel Guerrero | auto-disciplina-del-activista | filo | sin probar |
| [Violencia discursiva (la violencia del lenguaje)](#violencia-discursiva) | Romina Kachanoski | marco | filo | sin probar |
| [Por qué 'violencia' y no maltrato/crueldad/abuso/trastorno](#por-que-no-maltrato-rigor-conceptual) | Romina Kachanoski | premisa_portante | filo | sin probar |
| [El linaje de los Centrismos (especismo junto a sexismo/racismo)](#paralelo-luchas-sociales-centrismos) | Romina Kachanoski | marco | compasivo | sin probar |
| [Extrañarse de lo naturalizado (nombrar que un acto ES violencia)](#extranar-lo-naturalizado) | Romina Kachanoski | marco | compasivo | sin probar |
| [El filtro especie: dejar de ver al individuo para verlo como categoría](#filtro-especie-vs-individuo) | Romina Kachanoski | marco | compasivo | sin probar |
| [El semáforo: rojo (especismo) vs amarillo (welfarismo) vs el quiebre vegano](#semaforo-rojo-amarillo-welfarismo) | Romina Kachanoski | marco | filo | sin probar |
...
| [El problema no es cuánto sufre, es la consideración moral](#consideracion-moral-no-cuanto-sufre) | Romina Kachanoski | premisa_portante | compasivo | 1 deploy · pending ×1 |
...
| [Violencia indirecta: el que paga/demanda es responsable, no solo el que ejecuta](#violencia-indirecta-quien-demanda) | Romina Kachanoski | marco | filo | sin probar |
| [No necesitas convencer al 100%: basta el que está despertando](#sembrar-en-el-receptivo) | Romina Kachanoski | auto-disciplina-del-activista | compasivo | 1 deploy · pending ×1 |
...
| [La premisa falsa de que los animales 'nos dan' cosas](#premisa-falsa-los-animales-nos-dan) | Samuel Guerrero | marco | filo | sin probar |
...
| [El bienestarismo como jugada maestra: el poder saca el sufrimiento de la ecuación](#bienestarismo-jugada-maestra-del-poder) | Samuel Guerrero | marco | filo | sin probar |
...
| [Las imágenes gore se vuelven en contra: la vaca idílica gana](#gore-backfire-vaca-idilica) | Samuel Guerrero | auto-disciplina-del-activista | compasivo | sin probar |
| [El antropoespecismo es universal: deslocalizar la granja no resuelve nada](#antropoespecismo-universal-deslocalizar) | Samuel Guerrero | marco | filo | sin probar |
| [El sintomatismo: síntomas sueltos sin nexo que esconden la enfermedad](#sintomatismo-sintomas-inconexos) | Samuel Guerrero | auto-disciplina-del-activista | filo | sin probar |
| [NVC: separar la observación del juicio](#nvc-observacion-sin-juicio) | Marshall Rosenberg | auto-disciplina-del-activista | compasivo | sin probar |
| [IFS: hablarle al niño herido bajo la defensa](#ifs-hablarle-al-nino-herido) | Richard Schwartz | auto-disciplina-del-activista | compasivo | sin probar |
| [Entrevista Motivacional: evocar el cambio sin confrontar](#mi-evocar-cambio-sin-confrontar) | Miller & | auto-disciplina-del-activista | compasivo | sin probar |
...
| [La metáfora del frontón](#metafora-del-fronton) | Samuel Guerrero | auto-disciplina-del-activista | filo | sin probar |
| [Respetar a los animales no es una opción](#respetar-no-es-opcion) | Samuel Guerrero | marco | filo | sin probar |
...
| [Dominación ≠ superioridad moral: el poder fabricó el derecho, no lo justifica](#dominacion-no-es-superioridad-moral) | Bernard Uriza | marco | filo | sin probar |

## Por táctica del oponente — qué desplegar

Índice inverso: el contrincante usa la táctica de la izquierda → considera estos frameworks (cada uno con su `attack_surface`; ver detalle abajo).
...
| **Begging the Question / Circular Reasoning** (`peticion_de_principio`) | [El paralelismo con la esclavitud negra](#esclavitud-paralelismo) · [Domesticar es un eufemismo de dominar/someter](#domesticar-eufemismo-dominar) · [De algo a alguien — objeto de propiedad a sujeto de derecho](#algo-a-alguien-sujeto-derecho) · [El veganismo no es un estilo de vida (no se elige no ser racista)](#no-es-opcion-de-vida) · [El filtro especie: dejar de ver al individuo para verlo como categoría](#filtro-especie-vs-individuo) · [Respetar a los animales no es una opción](#respetar-no-es-opcion) |
...
### Antropoespecismo / Especismo Antropocéntrico
...
**Habilita:** Reencuadrar 'normal/natural' como una IDEOLOGÍA con nombre (supremacismo de especie), no un hecho neutro. Mueve la carga: nombrar el prejuicio obliga al otro a justificar la jerarquía, no al vegano a justificar la compasión.

**⚠️ attack_surface:** Bajo: es una definición ética, no un dato empírico — no se refuta con una excavación ni con biología. Riesgo real: el término 'antropoespecismo' es jerga; hay que traducirlo a lenguaje llano para el lurker ('la idea de que el humano vale más por ser humano').

**Contrarresta tácticas:** `naturalismo` (Appeal to Nature / Naturalismo) · `apelacion_normal` (Appeal to Normalcy / Default) · `species_hierarchy` (Species Hierarchy / Human Exceptionalism) · `relativismo_moral` (Moral Relativism Shield)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### Göbekli Tepe como 'kilómetro cero' del especismo
...
**Habilita:** Imagen potente para el lurker: si el especismo EMPEZÓ en un punto, puede TERMINAR — desnaturaliza el 'siempre ha sido así' sin pelear biología.

**⚠️ attack_surface:** ALTO. Descansa en la lectura romántica de Klaus Schmidt (religión antes que agricultura, cazadores-recolectores puros), HOY DEBATIDA: hoces de sílex, piedras de molienda, fitolitos de cereal y ocupación residencial apuntan a procesamiento de plantas y sedentarismo (Banning, 'Paradise Found or Common Sense Lost?', Open Archaeology 2022). NUNCA usar como premisa portante: un oponente fino ataca la arqueología y tira el argumento. Solo como marco con salida a prueba de concesión ('aunque me equivoque en la fecha exacta, la pregunta moral sigue en pie').

**Contrarresta tácticas:** `naturalismo` (Appeal to Nature / Naturalismo) · `presentismo` (Presentism / Dismiss the Trend) · `apelacion_normal` (Appeal to Normalcy / Default) · `species_hierarchy` (Species Hierarchy / Human Exceptionalism)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### Revolucionar la revolución (autocrítica del movimiento)
...
**Habilita:** NO es un arma contra el carnista — es disciplina interna del activista: precisión de lenguaje (no usar los eufemismos de la industria), encuadre abolicionista coherente (justicia, no dieta; alguien, no algo), rechazo de campañas single-issue/welfaristas incoherentes.

**⚠️ attack_surface:** No aplica como argumento al oponente (es meta-estrategia, no premisa de debate). Riesgo interno: el purismo de lenguaje puede leerse como gatekeeping ante un interlocutor de buena fe — en registro compasivo no se corrige al otro por decir 'carne'.

**Contrarresta tácticas:** `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### El paralelismo con la esclavitud negra
...
**Habilita:** Mueve el debate de 'son solo animales' a 'replicas la misma fórmula moral que hoy reconocemos como monstruosa'. El oponente queda obligado a nombrar QUÉ diferencia moral justifica la jerarquía, no a darla por hecha.
...
### El problema es que no sabemos que tenemos un problema
...
**Habilita:** Reencuadra la resistencia del oponente como síntoma, no como argumento. Permite no atacar a la persona sino al automatismo heredado, abriendo la puerta sin acusar.

**⚠️ attack_surface:** Roza el condescendiente 'tú no ves lo que yo sí': un oponente lo lee como 'me llamas inconsciente/adoctrinado' y se cierra. Es infalsable a la cara del rival; un lurker crítico huele la trampa de no-falsabilidad. Funciona como invitación, no como veredicto.

**Contrarresta tácticas:** `apelacion_normal` (Appeal to Normalcy / Default) · `futility_no_clean_option` (Futility / No Clean Option)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### Domesticar es un eufemismo de dominar/someter
...
**Habilita:** Desarma el lenguaje neutralizador en vivo: cada vez que el rival dice 'carne', 'ganadería', 'mascota', 'sacrificio', puedes nombrar el verbo crudo que el eufemismo oculta.

**⚠️ attack_surface:** El reemplazo 'matas' por 'asesinas/esclavizas' es discutible (categorías legales sobre personas) — un oponente fino dirá que TÚ usas lenguaje cargado y petición-de-principio. Sólido como observación sobre eufemismos suaves ('sacrificio'); resbaloso cuando adoptas el léxico máximo.

**Contrarresta tácticas:** `domestication_mutualism` (Domestication = Mutualism / Commensalism) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `peticion_de_principio` (Begging the Question / Circular Reasoning)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### De algo a alguien — objeto de propiedad a sujeto de derecho
...
**Habilita:** Convierte toda objeción de detalle (B12, Beyond Meat, depredadores) en irrelevante: la pregunta es de categoría, ¿es este ser un quién o un qué? No pide datos, pide una intuición que el lurker ya tiene sobre cualquier perro.
...
**Contrarresta tácticas:** `peticion_de_principio` (Begging the Question / Circular Reasoning) · `species_hierarchy` (Species Hierarchy / Human Exceptionalism) · `libertarian_autonomy` (Autonomy / Anti-Dictation Frame)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### La no-necesidad: las reglas del juego cambiaron para siempre
...
**Habilita:** Recorta el debate al único terreno que importa: si hay alternativa viable, la carga de justificar el daño cae entera sobre quien lo causa. Permite conceder el escenario náufrago/supervivencia sin perder nada.

**⚠️ attack_surface:** El propio Guerrero admite el hueco: la experimentación médica sin alternativa probada. Un oponente fino ataca ahí (medicamentos, zonas sin agricultura viable, pastoreo en tierra no cultivable) para mostrar que 'no necesidad' es generalización urbana del primer mundo. Sólido para el consumidor con supermercado; honestamente acotado fuera de él.

**Contrarresta tácticas:** `naturalismo` (Appeal to Nature / Naturalismo) · `futility_no_clean_option` (Futility / No Clean Option) · `crop_deaths_flip` (Crop Deaths / Bystander Flip) · `data_dump_selectivo` (Selective Data Dump)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### NJN — la trampa de normal, justo y necesario
...
**Habilita:** Una etiqueta para nombrar y desactivar de un golpe los tres esquives más comunes (natural/normal/necesario) como un solo reflejo heredado, no como tres argumentos.

**⚠️ attack_surface:** Etiquetar el argumento del otro como 'reflejo NJN' puede ser un esquive tuyo: psicologizas en vez de refutar ('lo dices porque estás adoctrinado') = ad-hominem genético. 'Necesario' es claim empírica refutable (remite a no-necesidad). Úsalo para reconocer el patrón, pero responde igual al fondo.

**Contrarresta tácticas:** `apelacion_normal` (Appeal to Normalcy / Default) · `naturalismo` (Appeal to Nature / Naturalismo) · `apelacion_mayoria` (Appeal to Majority / Bandwagon) · `popularidad_como_justificacion` (Popularity as Moral Proof)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### Matrix — éramos la pastilla azul, no nacimos despiertos
...
**Habilita:** Quita la superioridad moral del intercambio: 'yo comí igual que tú, mi familia no era mala gente'. Desarma la defensa del lurker que teme ser juzgado — el cambio se presenta como despertar compartido, no como acusación.

**⚠️ attack_surface:** La metáfora 'pastilla roja/despertar' tiene tufo a culto/iluminado; un oponente la voltea: 'el que cree haber despertado y ve lo oculto es el patrón del converso fanático'. Implica que disentir = seguir dormido (infalsable). Potente como autoconfesión humilde; tóxico si tacha al otro de dormido.

**Contrarresta tácticas:** `insulto_ad_hominem` (Ad Hominem / Dominance Social Attack) · `futility_no_clean_option` (Futility / No Clean Option)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### El conocimiento compromete — ya no puedes hacer como que no sabes
...
**Habilita:** Cierra la salida del 'respeto tu opinión / cada quien elige': tras la información, seguir consumiendo es una elección activa, no un default inocente. Mueve de 'preferencias' a 'complicidad consciente vs. toma de posición'.

**⚠️ attack_surface:** Es presión moral de borde culposo: el rival lo lee como chantaje y se atrinchera por reactancia. Asume que 'saber' produce un deber unívoco, saltándose el is-ought. Fuerte para quien ya está movido; contraproducente como martillo de culpa al escéptico.

**Contrarresta tácticas:** `is_ought` (Is-Ought / Naturalistic Fallacy) · `futility_no_clean_option` (Futility / No Clean Option) · `relativismo_moral` (Moral Relativism Shield)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### El veganismo no es dieta ni estilo de vida — el algodón ecológico
...
**Habilita:** Neutraliza el desvío hacia nutrición/proteína/recetas reencuadrando el veganismo como posición ética, no menú. 'Algodón ecológico = esclavitud ecológica' desmonta el bienestarismo y el consumo 'humanitario'.

**⚠️ attack_surface:** El reencuadre de 'estilo de vida' a 'imperativo ético' es justo lo que el oponente disputa — afirmarlo de entrada es petición de principio. El paralelismo 'no racista por un día' reapoya la analogía esclavista (mismo flanco caliente) y puede sonar a regañar al que da pasos.

**Contrarresta tácticas:** `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `relativismo_moral` (Moral Relativism Shield) · `libertarian_autonomy` (Autonomy / Anti-Dictation Frame)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### La dimensión política del veganismo — tomar posición
...
**Habilita:** Saca el veganismo de la esfera del consumo personal y lo planta junto al abolicionismo y el feminismo como lucha social. Responde a 'no me impongas tu opción' con 'ninguna lucha contra una opresión fue jamás una opción privada'.

**⚠️ attack_surface:** Lenguaje militante ('estamos en guerra', 'supremacista') que ante un lurker no convencido refuerza el cliché de 'vegano agresivo' — riesgo de perder al moderado. Invita la respuesta libertaria y la de 'es tu ideología'. Dosifícala, no abras con ella ante el silencioso.

**Contrarresta tácticas:** `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System) · `libertarian_autonomy` (Autonomy / Anti-Dictation Frame) · `relativismo_moral` (Moral Relativism Shield)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### Liberar una jaula vs. liberar tu mente
...
**Habilita:** Cierre de alto impacto que reencuadra el rescate individual hacia el cuestionamiento del sistema. La coda 'también las propias' devuelve al lurker a su propio condicionamiento sin acusarlo.

**⚠️ attack_surface:** Es frase de cierre épica/aforística — el tipo de 'conclusión demasiado perfecta' que en un reply de FB suena a IA (choca con reply-output-style: 'casi nunca una frase épica'). No argumenta, evoca. Úsala rarísimo y solo cuando el intercambio ya está ganado en sustancia.

**Contrarresta tácticas:** `apelacion_normal` (Appeal to Normalcy / Default) · `naturalismo` (Appeal to Nature / Naturalismo)

_Fuente: doctrine/rag/Antropoespecismo-Guerrero — texto extraido.md_

### La crueldad es el síntoma, no la causa
...
**Habilita:** Cuando el oponente reduce el debate a 'pero los tratan mal', se concede que la crueldad existe y se devuelve la carga al hueso: el problema no es cómo los usamos sino que los usamos. Desarma el bienestarismo sin pelear datos.

**⚠️ attack_surface:** El oponente puede leerlo como 'entonces si los matamos sin dolor no te quejas' — hay que cerrar de inmediato que la objeción es al uso, no al método. Un lurker puede sentir que minimizas el sufrimiento real al llamarlo 'mero síntoma'.

**Contrarresta tácticas:** `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `inversion_carga` (Burden of Proof Reversal)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### El pollo inconsciente (la trampa del sufrimiento cero)
...
**Habilita:** Caso límite contra cualquier postura welfarista o 'carne ética': si tu objeción era el dolor, un animal sin capacidad de sufrir te deja sin argumento; si igual te repugna, tu objeción siempre fue al uso, no al dolor. Fuerza a admitir que el problema es la propiedad.

**⚠️ attack_surface:** Es un escenario especulativo; un oponente lo descarta como ciencia ficción ('eso no existe'). Un welfarista utilitarista coherente sostendría que sin sufrimiento no hay daño — el reductio no los toca a ellos.

**Contrarresta tácticas:** `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `futility_no_clean_option` (Futility / No Clean Option) · `abolition_reductio` (Abolition Reductio / Domesticated Animal Extinction)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### Decir 'carne' sepulta a la víctima de un hachazo
...
**Habilita:** Auto-disciplina: el activista nombra al individuo (cerdo, vaca) en vez de 'carne/proteína'. Re-encuadra de 'comida' a 'cuerpo de alguien'. Aplica al re-leer un comentario aliado que cae en el eufemismo.

**⚠️ attack_surface:** Ante un lurker casual, insistir en no decir 'carne' se lee como purismo lingüístico o gatekeeping ('ni hablar normal puedes') y desvía del fondo a una pelea de vocabulario. El propio Samuel lo marca como 'lectura política, no personal' porque suena a regaño.

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### No 'explotación' ni 'maltrato': injusticia/esclavitud
...
**Habilita:** Elegir la palabra que ataca la causa (propiedad/jerarquía) en vez del método. 'Injusticia' deja los adjetivos ('cruel') para que los ponga la sociedad. Sustituir 'cruelty-free' por 'slavery-free' cambia la causa, no solo el discurso.

**⚠️ attack_surface:** Equiparar la cría animal con la esclavitud humana es la analogía que muchos rechazan como ofensiva/desproporcionada y puede alienar al lurker (apropiación del trauma humano). Samuel se adelanta ('os lo compro, pero no es la causa de fondo').

**Contrarresta tácticas:** `species_hierarchy` (Species Hierarchy / Human Exceptionalism)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### El carnismo manda el antropoespecismo de vuelta al anonimato
...
**Habilita:** Negarse a aceptar marcos que cosifican un solo síntoma (la dieta) como el problema, y devolver siempre a la cosmovisión raíz. Útil cuando alguien encuadra el veganismo solo como 'no comer animales' en vez de antiespecismo integral.

**⚠️ attack_surface:** Es debate intra-movimiento muy teórico; un lurker se pierde o lo lee como sectarismo ('pelean por nombres'). Joy defiende 'carnismo' como herramienta de visibilización — la crítica de Samuel es discutible, no consensuada.

**Contrarresta tácticas:** `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### Génesis: la Biblia promueve el antropoespecismo, no el veganismo
...
**Habilita:** Desactiva el argumento de autoridad escritural cuando un creyente lo usa: el mismo texto contiene el mandato de dominio. Pivote: no fundar la justicia animal en la Biblia, el cimiento es ético, no escritural.

**⚠️ attack_surface:** Es cherry-picking de versículos en ambas direcciones; un interlocutor versado trae mayordomía/dominio responsable (Gén 2:15), o señala que citar selectivamente no zanja nada moral (is-ought desde un texto antiguo). Mejor como neutralizador que como prueba.

**Contrarresta tácticas:** `principio_escudo` (Principle Shield / Begging the Principle) · `cherry_pick_empresa` (Cherry-Pick: One Company = Category)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### 'Vegano por un día' = racista solo entre semana
...
**Habilita:** Expone la incoherencia de pedir reducción parcial cuando el marco es de justicia, no de dieta. Devuelve el debate de '¿cuánto reduzco?' a '¿es esto una opción o una obligación moral?'.

**⚠️ attack_surface:** El gradualismo pragmático tiene defensa real (reduce daño total agregado, baja la barrera de entrada) — un lurker pragmático lo lee como purismo que ahuyenta a quien sí quería dar un paso. Depende de aceptar la equiparación con el racismo.

**Contrarresta tácticas:** `abolition_reductio` (Abolition Reductio / Domesticated Animal Extinction) · `species_hierarchy` (Species Hierarchy / Human Exceptionalism)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### El veganismo no es un estilo de vida (no se elige no ser racista)
...
**Habilita:** Bloquea el relativista 'es tu elección personal, respeta la mía': si es justicia, no gusto, la simetría 'tú comes plantas yo animales' se rompe — nadie diría 'respeta mi racismo'. Reubica de preferencia a moral.

**⚠️ attack_surface:** El interlocutor objeta que asume lo que debe probar (que comer animales es injusto como el racismo) = petición de principio; la analogía es justo el punto en disputa. Con filo a alguien de buena fe se lee como acusación ('me llamas racista'). Mejor plantando la pregunta que afirmando la equivalencia.

**Contrarresta tácticas:** `relativismo_moral` (Moral Relativism Shield) · `libertarian_autonomy` (Autonomy / Anti-Dictation Frame) · `peticion_de_principio` (Begging the Question / Circular Reasoning)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### 'Vegano' es un vocablo vacío: el norte es formar activistas
...
**Habilita:** Auto-disciplina estratégica: la meta no es sumar conversos a una dieta sino formar agentes que entiendan la causa y la difundan. Reorienta el éxito de '¿cuántos veganos hice?' a '¿desperté conciencia que se reproduce?'.

**⚠️ attack_surface:** Rechazar la etiqueta 'vegano' puede confundir o sonar a elitismo de pureza ('ni vegano de verdad eres') y diluye una palabra que el público ya reconoce — tirar el reconocimiento ganado del término tiene costo táctico discutible.

**Contrarresta tácticas:** `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### Entender no es aceptar ni transformarse
...
**Habilita:** Desmonta la excusa pesimista del propio activista ('la gente no llega') y reubica: el que dice 'no entiendo' casi siempre entendió y resiste la implicación. Separa comprensión de compromiso sin acusar.

**⚠️ attack_surface:** Asumir 'ya entendiste, solo te resistes' puede leerse como arrogancia o negar la objeción de buena fe ('no es que no quiera, es que no me convence tu premisa'). Con filo invalida al interlocutor y enciende defensas.

**Contrarresta tácticas:** `futility_no_clean_option` (Futility / No Clean Option)

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### Me preocupa más el movimiento que la sociedad
...
**Habilita:** Justifica la autocrítica dura como prioridad: corregir el propio discurso antes que culpar a la sociedad. Norte para el pipeline: un mal reply/encuadre propio desperdicia al lurker y hay que afilarlo, no excusarlo en 'la sociedad no entiende'.

**⚠️ attack_surface:** Volcar el foco crítico hacia dentro puede leerse como fuego amigo/divisionismo que desmoraliza a la base, y un oponente externo lo explota ('hasta ellos admiten que están confundidos'). El balance autocrítica/unidad es disputable.

_Fuente: doctrine/rag/Revolucionar-la-revolucion-Guerrero — texto extraido.md_

### El especismo es una programación heredada en la infancia
...
**Habilita:** Cuando el oponente dice que comer animales es 'natural' o 'lo normal', se le devuelve que lo que confunde con naturaleza es una conducta aprendida desde antes de poder consentirla. Como nadie nace racista o sexista, nadie nace especista: lo recibió de cuatro instituciones que nunca le preguntaron.

**⚠️ attack_surface:** Decir 'te programaron' puede leerse como negarle agencia o tratarlo de adoctrinado, lo pone a la defensiva. Invita al tu-quoque ('a ti también te programaron para ser vegano'). Aplicarlo a la cultura, no a la persona, y reconocer que uno también mamó el prejuicio.

**Contrarresta tácticas:** `naturalismo` (Appeal to Nature / Naturalismo) · `apelacion_normal` (Appeal to Normalcy / Default)

_Fuente: doctrine/rag/Educacion-Especista-Guerrero — texto extraido.md_

### Especismo económico: 'nos quedaríamos sin trabajo'
...
**Habilita:** Cuando alguien defiende ganadería/pesca con 'la gente vive de eso', se contesta con el paralelo histórico: nadie preguntó de qué viviría el verdugo al abolir la pena de muerte, ni los negreros al abolir la esclavitud. Un empleo nunca justificó moralmente lo que hace. La pregunta no es 'de qué vivirán' sino 'es esto un oficio defendible'.

**⚠️ attack_surface:** El paralelo con verdugos y negreros puede sentirse como acusar de criminales a trabajadores precarios de mataderos/pesca sin otra salida; backfire de clase. Separar la condena del sistema/oficio de la condena de la persona atrapada en él.

**Contrarresta tácticas:** `futility_no_clean_option` (Futility / No Clean Option)

_Fuente: doctrine/rag/Educacion-Especista-Guerrero — texto extraido.md_

### Para sostener el sistema hay que mentirles a las criaturas
...
**Habilita:** Frente a 'es solo comida, no le des vueltas', se señala que toda la 'normalidad' del producto depende de ocultarle a un niño de dónde viene. Si fuera defensible no necesitaría ese velo: a nadie hay que mentirle sobre comer una manzana. Que se mienta es la prueba de que la conciencia infantil rechazaría la verdad.

**⚠️ attack_surface:** Se puede contestar que a los niños se les oculta también la muerte, el sexo o la guerra sin que eso vuelva inmorales esas cosas; ocultar algo crudo no prueba que sea malo, solo que es crudo. Hay que sostener que aquí lo ocultado es la víctima misma, no la mera dureza.

**Contrarresta tácticas:** `apelacion_normal` (Appeal to Normalcy / Default)

_Fuente: doctrine/rag/Educacion-Especista-Guerrero — texto extraido.md_

### La premisa falsa de que los animales 'nos dan' cosas
...
**Habilita:** Cuando el oponente usa el lenguaje del don ('la leche la dan igual', 'los huevos no le duelen'), se aplica el test de sustitución por una hembra humana. El verbo 'dar' colapsa y queda al desnudo que hay apropiación de un cuerpo ajeno, no un regalo. Reencuadra el consentimiento que el lenguaje finge.

**⚠️ attack_surface:** El test de sustituir por una hembra humana puede tacharse de antropomorfismo o comparación tramposa entre especies; el oponente dirá que la vaca fue criada para eso y que no hay sujeto que consienta. Sostener que la cría intencional no genera el derecho a apropiarse, sino que es parte del problema.

**Contrarresta tácticas:** `domestication_mutualism` (Domestication = Mutualism / Commensalism)

_Fuente: doctrine/rag/Educacion-Especista-Guerrero — texto extraido.md_

### Los libros enseñan al animal en partes, nunca su sintiencia
...
**⚠️ attack_surface:** Se puede objetar que un libro describe anatomía igual para una planta sin negar nada moralmente; la omisión podría ser neutralidad científica, no conspiración. Apoyarse en la etología cognitiva para que el reclamo sea de evidencia, no de intención presunta.

**Contrarresta tácticas:** `species_hierarchy` (Species Hierarchy / Human Exceptionalism)

_Fuente: doctrine/rag/Educacion-Especista-Guerrero — texto extraido.md_

### Solo se normaliza una parte de la realidad (el kit de carnicería)
...
**Habilita:** Cuando dicen 'es la realidad, los niños tienen que conocerla', se devuelve que falta el resto: el matadero, el cuchillo, la sangre. Solo se 'normaliza' el tramo que no incomoda. Esa selección revela que no es educación sobre la realidad sino higienización de una práctica que no resistiría verse entera.

**⚠️ attack_surface:** El oponente puede decir que tampoco hay juguetes de tanatorios o tribunales sin que eso oculte nada siniestro, solo no son temas de juego; la ausencia del kit-matadero podría ser pudor general. Apoyarse en que el kit-granja SÍ existe pero recorta justo la matanza.

**Contrarresta tácticas:** `apelacion_normal` (Appeal to Normalcy / Default)

_Fuente: doctrine/rag/Educacion-Especista-Guerrero — texto extraido.md_

### El educador no hace campaña: responde cuando el tema surge
...
### Respetar a la persona no obliga a respetar la idea inmoral
...
**Habilita:** Cuando piden 'respeto por su elección', se concede el respeto a él como persona y se niega al acto: 'a ti te respeto, lo que no respeto es lo que haces, porque comporta muerte de otros'. Saca el debate del marco de preferencias (donde se atrinchera) y lo lleva al de justicia, donde el daño a terceros sí se juzga.

**⚠️ attack_surface:** Equiparar al consumidor de carne con un maltratador/racista es la comparación de mayor backfire: el lurker carnista se siente acusado de monstruo y se cierra. Sin cordialidad explícita, el filo se lee como insulto y pierde al observador.

**Contrarresta tácticas:** `relativismo_moral` (Moral Relativism Shield) · `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System)

_Fuente: doctrine/rag/Educacion-Especista-Guerrero — texto extraido.md_

### El single-issue diluye el mensaje antiespecista
...
**Habilita:** Cuando un activista o crítico mete el debate vegano en un paquete de single-issues, nombrar que cada causa añadida tapa la pregunta moral central en vez de reforzarla — exigir que el frame antiespecista vaya como consigna principal, no como una más del crisol.

**⚠️ attack_surface:** Backfire por purismo: el interlocutor puede acusar de sectarismo o de despreciar aliados ecologistas/sanitarios. Contestable empíricamente — coaliciones amplias a veces SÍ movilizan más; claridad vs. alcance es un trade-off real.

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### La pandemia cooptada como argumento — la cultura del 'todo vale'
...
**Habilita:** Frente al activista que reutiliza la última crisis sanitaria como gancho, advertir que el argumento 'comer animales nos enferma' subordina a los animales a un beneficio humano y se evapora cuando la amenaza cambia — no toca la raíz moral.

**⚠️ attack_surface:** El propio Guerrero admite que esos argumentos pueden 'servir' tácticamente. Un pragmático responde que ganar atención con un gancho de salud y luego pivotar a la ética es lícito. La pureza del frame puede costar oyentes que entran por interés propio.

**Contrarresta tácticas:** `whataboutism` (Whataboutism / Human Exploitation Deflection)

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### El bienestarismo como jugada maestra: el poder saca el sufrimiento de la ecuación
...
**Habilita:** Cuando alguien ofrece 'trato humanitario', huevos de pastoreo o carne 'feliz', mostrar que mejorar las condiciones deja el vínculo de propiedad/uso intacto: la pregunta no es cómo se esclaviza sino si hay derecho a esclavizar dada la no-necesidad.

**⚠️ attack_surface:** El bienestarista responde que menos sufrimiento ES progreso moral real para los animales que viven ahora, y acusa al abolicionista de sacrificar reducción concreta de daño por pureza teórica. El lurker puede leer el rechazo al bienestar como frialdad.

**Contrarresta tácticas:** `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `cherry_pick_empresa` (Cherry-Pick: One Company = Category)

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### Elige el objetivo: consideración moral, no fin del sufrimiento
...
**Habilita:** Auto-chequeo y reencuadre: antes de aceptar una victoria parcial (jaulas más grandes, aturdimiento), preguntar si acerca la consideración moral o solo limpia el síntoma. Reorienta cada reply al estatus del animal como sujeto, no como paciente de sufrimiento.

**⚠️ attack_surface:** Un consecuencialista dirá que 'consideración moral' es una abstracción que no alimenta a nadie, mientras reducir sufrimiento es medible y real. Puede leerse como anteponer la pureza del principio al alivio concreto.

**Contrarresta tácticas:** `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense)

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### El filtro natural: informar es un deber, ser informado es un derecho
...
**Habilita:** Auto-disciplina del tono: no acorralar ni forzar la conversión. Ofrecer el argumento con claridad y soltar la urgencia de convencer al oponente cerrado — el rendimiento está en el lurker que se acerca solo, no en someter al que se resiste.

**⚠️ attack_surface:** Pasivo de más para urgencias: un crítico dirá que 'esperar a que se acerquen' es lujo de quien no sangra. Aplicado mal, racionaliza no incomodar nunca.

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### El mensaje importa, pero las formas son determinantes
...
**Habilita:** Recordatorio pre-post: un argumento correcto entregado como sermón o avalancha de datos produce el rechazo que quería evitar. Calibrar la forma (registro, longitud, no acorralar) es parte del contenido — ata directo con el style-gate del pipeline.

**⚠️ attack_surface:** Riesgo de usarse como excusa para diluir el contenido ('suavízalo tanto que ya no dice nada'). El equilibrio forma/fondo es subjetivo; alguien puede esconder cobardía argumental detrás de 'cuidar las formas'.

**Contrarresta tácticas:** `data_dump_selectivo` (Selective Data Dump)

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### Las imágenes gore se vuelven en contra: la vaca idílica gana
...
**Habilita:** Argumento contra apoyarse en el shock: la imagen sangrienta deja al espectador eligiendo la versión 'amable' de la explotación en vez de cuestionarla. Si contextualizas (idílico también es injusticia), expones que el problema es el uso, no la brutalidad visible.

**⚠️ attack_surface:** Contestable empíricamente: parte del activismo (Cubes of Truth) reporta conversiones vía imágenes. 'Causa rechazo' es generalización que el propio Guerrero matiza. El backfire del gore depende de público y encuadre, no es ley.

**Contrarresta tácticas:** `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense)

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### El antropoespecismo es universal: deslocalizar la granja no resuelve nada
...
**Habilita:** Contra la campaña NIMBY/ecologista que persigue una instalación concreta: nombrar que ganar el 'no en mi territorio' reubica el daño sin tocarlo. Devuelve el foco de la geografía/ambiente a la relación de uso, que es deslocalizada — el objetivo es el vínculo, no el predio.

**⚠️ attack_surface:** Un organizador territorial dirá que las victorias locales sí importan (menos animales explotados aquí y ahora, poder construido, precedente legal) y que despreciarlas por 'no resolver la raíz' deja pasar palancas reales. El absolutismo puede paralizar la acción concreta.

**Contrarresta tácticas:** `futility_no_clean_option` (Futility / No Clean Option)

_Fuente: doctrine/rag/Avolicion-Guerrero — texto extraido.md_

### El sintomatismo: síntomas sueltos sin nexo que esconden la enfermedad
...
**Habilita:** Auto-disciplina para no fragmentar la lucha en indignaciones inconexas: cada síntoma denunciado debe anclarse explícitamente a la causa común (el uso de animales como recurso). En un hilo, conectar el caso puntual con el frame de fondo en vez de tratarlo como escándalo aislado.
...
**Habilita:** Autodisciplina: el mensaje que emites determina lo que la sociedad refleja de vuelta. Si relacionas el veganismo con dieta/salud/moda/crueldad, lo absorbe como opción reversible; si lo relacionas con el antropoespecismo, refleja el problema de fondo. Obliga a auditar el mensaje propio antes de culpar al receptor.

**⚠️ attack_surface:** Es una analogía mecánica: la recepción social real es más ruidosa que un frontón (medios, contramensajes de la industria, sesgos previos). No prueba causalidad — que 'opción' emitido y 'opción' percibido co-ocurran no demuestra que uno generó al otro.

_Fuente: doctrine/rag/Veganismo-Politico-Guerrero — texto extraido.md_

### Respetar a los animales no es una opción
...
**Habilita:** Desarma el 'cada quien elige'. Ser surfer o budista sí es opción legítima — nadie está obligado a serlo. Pero empaquetar el veganismo como estilo/filosofía de vida lo degrada a preferencia, igualando 'no ser racista' con 'ser racista'. La justicia hacia un tercero no es electiva.

**⚠️ attack_surface:** El interlocutor responde que la analogía con el racismo asume ya resuelto el estatus moral del animal (petición de principio): solo es 'injusticia electiva' si los animales ya cuentan moralmente, que es justo lo en disputa.

**Contrarresta tácticas:** `relativismo_moral` (Moral Relativism Shield) · `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System) · `libertarian_autonomy` (Autonomy / Anti-Dictation Frame) · `peticion_de_principio` (Begging the Question / Circular Reasoning)

_Fuente: doctrine/rag/Veganismo-Politico-Guerrero — texto extraido.md_

### La dimensión política: sacarlo a la calle y entrar en las estructuras de poder
...
**Habilita:** Separa el veganismo individual (no consumir) del político (transformar lo colectivo). La tercera dimensión convierte al vegano en activista: el cambio personal no se completa hasta que se proyecta socialmente y disputa el poder institucional. Distingue 'dejé de consumir' de 'lucho por cambiar la matriz'.

**⚠️ attack_surface:** Puede leerse como inflación de exigencias: convierte una posición de consumo defendible en un mandato de militancia, lo que aliena a quien comparte el fin pero no la vocación activista. El salto de 'no participo de la injusticia' a 'debo entrar en las estructuras de poder' no es obvio.

_Fuente: doctrine/rag/Veganismo-Politico-Guerrero — texto extraido.md_

### Antropoespecismo y veganismo: las dos caras de la misma moneda
...
**Habilita:** Ancla el veganismo a su negación, no a una dieta. Cada creencia antropoespecista dada por válida sin examen (los necesitamos, nos sirven, nos pertenecen, somos superiores, son propiedad, somos distintos) se invierte. Ser vegano = dejar de ser antropoespecista; el plato es síntoma, la creencia es la raíz. Reencuadra el debate de la conducta a la cosmovisión.

**⚠️ attack_surface:** Llamar 'certezas' a posiciones éticas (no somos superiores, no nos pertenecen) es discutible: la no-necesidad es empírica, pero el estatus moral no se 'comprueba' como un hecho — desliza juicios de valor bajo el lenguaje de la prueba.

**Contrarresta tácticas:** `apelacion_normal` (Appeal to Normalcy / Default) · `naturalismo` (Appeal to Nature / Naturalismo) · `species_hierarchy` (Species Hierarchy / Human Exceptionalism) · `is_ought` (Is-Ought / Naturalistic Fallacy)

_Fuente: doctrine/rag/Veganismo-Politico-Guerrero — texto extraido.md_

### La transformación es de dentro hacia afuera — informa y retírate
...
**Habilita:** Autodisciplina contra el acoso militante. Seedear la información una vez y retirarse —no insistir, no re-preguntar— porque la decisión genuina solo es robusta si nace del poder de decisión propio. Lo impuesto se rechaza; lo elegido es inquebrantable. Con quien no quiere saber, dejarlo: hay un millón esperando recibir la información.

**⚠️ attack_surface:** Puede racionalizar la inacción ('ya informé, me retiro') y subestima que mucha gente cambia precisamente por presión social sostenida o normas que preceden a la convicción. La dicotomía impuesto/elegido es más porosa de lo que plantea.
...
**Habilita:** Nombra la explotación como VIOLENCIA (no 'uso', 'producción', 'sacrificio') y la equipara estructuralmente a violencias sociales que el interlocutor ya condena. Quita el eufemismo del lenguaje del otro.

**⚠️ attack_surface:** Bajo como marco ético; medio en Facebook: 'violencia' puede leerse como acusación personal y cerrar al interlocutor de buena fe (el registro compasivo lo modula). La jerga taxonómica del ENFOC (5 dimensiones) NO va literal a un comentario.

**Contrarresta tácticas:** `relativismo_moral` (Moral Relativism Shield) · `apelacion_normal` (Appeal to Normalcy / Default) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_
...
**Habilita:** Nombra la escala industrial como exterminio estructural, no actos individuales — desplaza la conversación de '¿por qué TÚ comes carne?' a 'qué sistema sostiene esto'.

**⚠️ attack_surface:** ALTO en Facebook: el paralelo con genocidio enciende y se lee como exageración u ofensa ante el lurker; reservar para audiencia ya sensibilizada, casi nunca en debate abierto. Término muy de nicho académico.

**Contrarresta tácticas:** `relativismo_moral` (Moral Relativism Shield) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### Violencia discursiva (la violencia del lenguaje)
...
**Habilita:** Nombrar que el lenguaje normalizado del interlocutor ('humane meat', 'livestock', 'it's just food') no es neutral: es el mecanismo que invisibiliza el acto como violencia. Señala la disonancia cognitiva sin acusar de maldad.

**⚠️ attack_surface:** Si se vuelve corrección lingüística ('no digas pescado'), el lurker lo lee como policía del lenguaje y se desconecta. La jerga 'violencia discursiva' suena académica; traducir a 'fíjate qué palabra usaste y qué esconde'. Backfire fácil con el 'son solo palabras'.

**Contrarresta tácticas:** `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System) · `apelacion_normal` (Appeal to Normalcy / Default)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### Por qué 'violencia' y no maltrato/crueldad/abuso/trastorno
...
**Habilita:** Bloquear el desvío welfarista de raíz: 'sí, el maltrato está mal' deja intacta la propiedad (implica buen-trato); 'crueldad de unos enfermos' lo hace patología individual en vez de violencia social normalizada. Mueve de 'cuánto sufre' a 'qué consideración tiene'.

**⚠️ attack_surface:** Llamar 'violencia' a comer carne enciende a quien se siente acusado de violento; el lurker puede leerlo como inflación retórica. Anclar en la estructura ('es la norma, no casos aislados'), no en el insulto. El que dice 'pero yo SÍ trato bien a mis animales' usa exactamente el marco buen-trato que esto desmonta.

**Contrarresta tácticas:** `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `moving_goalposts` (Moving Goalposts)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### El linaje de los Centrismos (especismo junto a sexismo/racismo)
...
**Habilita:** Da andamiaje histórico al lurker: cada lucha 'invisible' fue ridícula hasta que la sociedad la nombró. Convierte la rareza de la postura vegana en la fase temprana predecible de una lucha ya validada.

**⚠️ attack_surface:** Equiparar especie con raza/género enciende muchísimo: 'comparas mi cena con el Holocausto'. Detonante #1 de hostilidad. Nunca como acusación ('eres como un nazi') sino como estructura ('comparten la misma raíz: creer en una superioridad'). También puede ofender a los grupos humanos oprimidos.

**Contrarresta tácticas:** `species_hierarchy` (Species Hierarchy / Human Exceptionalism) · `apelacion_normal` (Appeal to Normalcy / Default) · `predator_comparison` (Predator Comparison / Lion Argument)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### Extrañarse de lo naturalizado (nombrar que un acto ES violencia)
...
**Habilita:** Micro-acción para el lurker: mira el acto un segundo SIN la etiqueta que lo justifica. Invierte la carga — no hay que demostrar que está mal, hay que explicar qué justificación convierte 'esto es violencia' en 'esto es normal'.

**⚠️ attack_surface:** Si suena a 'abre los ojos, ovejas', es condescendiente y backfire. Funciona como invitación ('mira un segundo'), no como sentencia. El de mala fe responde 'ya lo miré y sigue siendo comida' — ahí no se insiste, se planta para el lurker.

**Contrarresta tácticas:** `apelacion_normal` (Appeal to Normalcy / Default) · `popularidad_como_justificacion` (Popularity as Moral Proof) · `naturalismo` (Appeal to Nature / Naturalismo)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### El filtro especie: dejar de ver al individuo para verlo como categoría
...
**Habilita:** Re-individualiza a la víctima: el interlocutor argumenta sobre 'los animales' (categoría abstracta); devuélvelo a 'este individuo que quiere vivir'. Nombra el truco: la justificación especista funciona borrando al individuo bajo la etiqueta de especie.

**⚠️ attack_surface:** Antropomorfización: 'le atribuyes individualidad a una res'. El interlocutor pide que demuestres que un pollo es 'individuo' en sentido moral relevante (sentiencia, intereses) — hay que tener esa respuesta. 'Persona más allá de la especie' es jerga; traducir a 'un alguien, no un algo'.

**Contrarresta tácticas:** `species_hierarchy` (Species Hierarchy / Human Exceptionalism) · `peticion_de_principio` (Begging the Question / Circular Reasoning) · `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### El semáforo: rojo (especismo) vs amarillo (welfarismo) vs el quiebre vegano
...
**Habilita:** Ubica al interlocutor en el tablero: el que dice 'estoy por el bienestar / jaulas más grandes' está en AMARILLO — debate magnitud, no estatus. Diagnostica el welfarismo como especismo suave, no como aliado.

**⚠️ attack_surface:** Llamar 'esclavitud' a la ganadería es el detonante de la analogía esclavista — backfire alto con quien lo lee como banalizar la esclavitud humana. El bienestarista se siente atacado por un aliado y se cierra. Mejor describiendo la posición que etiquetando a la persona.

**Contrarresta tácticas:** `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `moving_goalposts` (Moving Goalposts) · `abolition_reductio` (Abolition Reductio / Domesticated Animal Extinction)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### El árbol: especismo es la raíz, la violencia es el síntoma visible
...
**Habilita:** Evita la trampa de discutir casos aislados (este matadero, esta corrida). Cuando el interlocutor concede 'esa práctica es cruel' pero defiende el resto, se muestra que poda una hoja mientras la raíz produce síntomas nuevos. Concede lo empírico de la hoja sin perder el tronco.

**⚠️ attack_surface:** Es metáfora, no argumento — el riguroso pide que demuestres que la 'raíz' es injustificada, no solo que existe. Riesgo de sonar a clase magistral; en un comentario va una línea ('podas una hoja, no la raíz'), no el árbol completo.

**Contrarresta tácticas:** `cherry_pick_empresa` (Cherry-Pick: One Company = Category) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `moving_goalposts` (Moving Goalposts)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### El problema no es cuánto sufre, es la consideración moral
...
**Habilita:** El movimiento de inversión de carga por excelencia: cualquier debate técnico sobre sufrimiento (anestesia, sacrificio humanitario) se concede y se devuelve al estatus. 'No discuto cuánto sufre — discuto qué justifica tratarlo como propiedad de entrada'.

**⚠️ attack_surface:** Si el sufrimiento es irrelevante, preguntan '¿entonces matar sin dolor está bien?' — hay que tener clara la respuesta (el estatus de propiedad/uso es el problema) o parece que esquivas. 'Esclavo/a' aplicado a animales es detonante. 'Asimétrico y opresivo' es jerga; traducir a 'uno decide sobre la vida del otro'.

**Contrarresta tácticas:** `inversion_carga` (Burden of Proof Reversal) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense) · `principio_escudo` (Principle Shield / Begging the Principle)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### Violencia estructural: el aparataje que sostiene (mataderos como infraestructura)
...
**Habilita:** Saca el debate del acto individual ('mi elección personal') hacia el sistema que lo hace posible y rentable. Cuando dicen 'es mi decisión privada comer carne', se muestra que es la punta de una infraestructura masiva. Útil contra el 'votar con el tenedor' como gusto personal.

**⚠️ attack_surface:** 'Especidio' invoca genocidio — máximo voltaje, casi siempre backfire en comentario abierto; reservar para el lurker avanzado, nunca para abrir. 'Aparataje/infraestructura' suena marxista-académico. El interlocutor contraargumenta con empleos/economía/tradición.

**Contrarresta tácticas:** `libertarian_autonomy` (Autonomy / Anti-Dictation Frame) · `domestication_mutualism` (Domestication = Mutualism / Commensalism) · `futility_no_clean_option` (Futility / No Clean Option)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### Violencia indirecta: el que paga/demanda es responsable, no solo el que ejecuta
...
**Habilita:** Desactiva la distancia moral del consumidor: 'yo no mato, yo solo compro'. La demanda con dinero ES el acto — el matarife ejecuta una orden que firmaste al pagar. Cierra la disociación 'donde dejas de verla, se vuelve invisible'.

**⚠️ attack_surface:** El '99% lo hace' puede sonar a culpabilizar a todos por igual — backfire si se lee como condena masiva. El interlocutor responde con cadenas de complicidad infinitas ('entonces tú también, por X') tipo whataboutism. Mejor como observación que como acusación personal.

**Contrarresta tácticas:** `whataboutism` (Whataboutism / Human Exploitation Deflection) · `futility_no_clean_option` (Futility / No Clean Option) · `crop_deaths_flip` (Crop Deaths / Bystander Flip)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

### No necesitas convencer al 100%: basta el que está despertando
...
**Habilita:** Recalibra el objetivo — no ganarle al oponente cerrado sino sembrar en el lurker receptivo (el norte del reply-output-style: el lector silencioso). Libera de la frustración de no 'cerrar' al troll: el éxito es plantar la herramienta, no la rendición del rival.

**⚠️ attack_surface:** Es disciplina interna, no munición de debate — si se dice en voz alta ('no espero que TÚ entiendas, escribo para otros') se lee como desdén al interlocutor y enciende. Nunca verbalizar 'no me dirijo a ti'; mantenerlo como brújula del activista.

**Contrarresta tácticas:** `futility_no_clean_option` (Futility / No Clean Option) · `insulto_ad_hominem` (Ad Hominem / Dominance Social Attack)

_Fuente: doctrine/rag/Violencia-Especista-Kachanoski — texto extraido.md_

## Marshall Rosenberg (NVC)

### NVC: separar la observación del juicio
...
**Habilita:** En un hilo: describir la práctica (criar y matar seres sintientes para un plato evitable) sin colgarle al interlocutor la etiqueta 'asesino/cruel/hipócrita'. El hecho queda plantado para el lurker; la persona no recibe el ataque que la haría defenderse en vez de pensar. Es la base que evita el sermón moralista que el registro compasivo prohíbe.

**⚠️ attack_surface:** No es un argumento contra el oponente — es auto-disciplina del que escribe. Riesgo: confundirse con tibieza (describir sin nombrar nada se lee como no decir nada); la observación debe seguir devolviendo al hueso, no diluirlo. Mal usada, un activista la convierte en eufemismo y pierde el filo del marco.

**Contrarresta tácticas:** `insulto_ad_hominem` (Ad Hominem / Dominance Social Attack)

_Fuente: doctrine/rag/Nonviolent Communication (Rosenberg) — texto extraido.md_

## Richard Schwartz (IFS / Sistemas Familiares Internos)

### IFS: hablarle al niño herido bajo la defensa
...
**Habilita:** Releer el insulto o la defensa agresiva como un protector que cuida una herida (culpa, complicidad sentida, miedo a que el marco propio se caiga), no como la persona entera. Permite no contraatacar al protector sino dirigirse, con calma, a lo que protege — el contraste de temperamento que desarma ante el lurker. Mapea directo al 'padre invertido' de la doctrina compasiva.

**⚠️ attack_surface:** Jerga clínica (exiliados/protectores) NUNCA va al comentario — es lente interno del que escribe, no diagnóstico que se le suelta al otro ('tu parte herida habla' es condescendiente y enciende). Riesgo de psicologizar al oponente en público: se lee como superioridad terapéutica. Solo informa el TONO, no se nombra.

**Contrarresta tácticas:** `insulto_ad_hominem` (Ad Hominem / Dominance Social Attack)

_Fuente: doctrine/rag/IFS - Sistemas Familiares Internos (Schwartz) — texto extraido.md_

## Miller & Rollnick (Entrevista Motivacional)

### Entrevista Motivacional: evocar el cambio sin confrontar
...
**Habilita:** Resistir el 'reflejo de corregir' (rebatir cada esquive empuja al otro a defender su posición más fuerte). En vez de demoler, plantar la pregunta y dejar que la incomodidad la trabaje el propio interlocutor — y sobre todo el lurker, que resuelve su ambivalencia en silencio. Justifica la disciplina de NO perseguir cada desvío y devolver al hueso una sola vez.

**⚠️ attack_surface:** No es un arma de debate sino un estilo. Riesgo en Facebook: la EM clínica asume una alianza colaborativa que un hilo hostil no da — aplicada literal se ve pasiva. Acá sirve para el lurker, no para 'sanar' al oponente (límite duro del registro compasivo). Si el interlocutor es de mala fe confirmada, el registro correcto es el filo, no seguir evocando.

**Contrarresta tácticas:** `socrates_hostil` (Hostile Socratic Method) · `reencuadre_veganismo_creencia` (Reframe: Veganism as Belief System)

_Fuente: doctrine/rag/Entrevista Motivacional (Miller-Rollnick) — texto extraido.md_

### Entrevista Motivacional: desarrollar la discrepancia
...
**Habilita:** Anclar el marco en un valor que el interlocutor YA declara ('los animales me importan', 'el sufrimiento innecesario está mal') y mostrar la distancia con la práctica, sin acusar. El lurker que comparte ese valor siente la grieta en cabeza propia. Es la versión compasiva de la inversión de carga: no impone una moral ajena, expone la que el otro ya dijo tener.

**⚠️ attack_surface:** Roza el 'te pillé en contradicción' si se hace con tono de gotcha — ahí se vuelve hostil y dispara la defensa que querías evitar. La discrepancia se OFRECE como pregunta, no se clava como veredicto. Un oponente puede negar el valor de partida ('no, los animales no me importan'); ahí el ancla desaparece y el registro cambia.
...
### Trauma-Informed: la defensa no es maldad, es protección
...
**Habilita:** Mantener al que escribe en el rol de 'adulto en la sala' que no contraataca — el contraste que el lurker registra. Despersonaliza la hostilidad (es la disonancia hablando, no la persona), lo que sostiene la calma del registro compasivo bajo fuego sin convertirla en sumisión.

**⚠️ attack_surface:** Lente interno, no etiqueta pública: decirle a alguien 'reaccionas así por un trauma' es patologizar y ofende. Riesgo de excusar todo como trauma y nunca nombrar la evasión — la compasión no borra la responsabilidad ni el hecho. No aplica a trolls puros (no hay herida que cuidar, solo deporte).

**Contrarresta tácticas:** `insulto_ad_hominem` (Ad Hominem / Dominance Social Attack) · `anecdota_personal_n1` (Personal Anecdote as Category Evidence)

_Fuente: doctrine/rag/Trauma-Informed Care (SAMHSA) — texto extraido.md_

## Bowlby, Ainsworth & Main (Teoría del Apego)

### Teoría del Apego: la seguridad precede a la apertura
...
**Habilita:** Justifica bajar la amenaza antes de plantar el marco: validar lo legítimo de la posición del otro ('claro que los humanos pueden comer carne', 'tiene sentido que te moleste el tono moralista') abre una ventana donde la pregunta del hueso puede entrar — en él y, sobre todo, en el lurker. Es la base teórica de 'si atacan más, subí ternura, no volumen'.

**⚠️ attack_surface:** No es argumento sino estrategia de tono. Riesgo: convertir 'dar seguridad' en complacencia que nunca confronta el marco — la seguridad es para que la pregunta entre, no para evitarla. Con un interlocutor de mala fe que usa la cortesía como escudo, dar más seguridad refuerza el escudo; ahí el registro correcto es el filo controlado.

**Contrarresta tácticas:** `data_dump_selectivo` (Selective Data Dump) · `welfare_rhetoric` (Welfare Rhetoric / Comfortable Life Defense)

_Fuente: doctrine/rag/Teoria del Apego (Bowlby-Ainsworth-Main) — texto extraido.md_

## Bernard Uriza Orozco

### Dominación ≠ superioridad moral: el poder fabricó el derecho, no lo justifica
